...
<root>
  ...
  ├── Editor
  │   ├── Jykgod.Jquadtree.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Jykgod.Jquadtree.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Jykgod.Jquadtree.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Jykgod.Jquadtree.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Jykgod.Jquadtree`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package JQuadTree Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Jykgod.Jquadtree.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Jykgod.Jquadtree.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Jykgod.Jquadtree.Editor.Tests.asmdef`

  `Tests/Runtime/Jykgod.Jquadtree.Tests.asmdef`
...
Use the `Documentations~/JQuadTree.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
